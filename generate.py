...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--decode_mode", choices=["auto", "ar", "nonseq"], default="nonseq", help="Default nonseq uses DVSD decoding; ar (stateful streaming cache) is opt-in, and auto only selects nonseq outside strict streaming core")
