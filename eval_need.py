#!/usr/bin/env python3
"""Fixed evaluation harness for NEED checkpoints.

This complements need_eval.py with lightweight behavioral suites: simple QA,
arithmetic, instruction following, safety/refusal, summarization, controller and
sidecar trace metrics.  It avoids external benchmark dependencies so it can run
inside the repo on small checkpoints.
"""
