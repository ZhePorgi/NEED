...
Made for a Linux or macOS environment, if you want to use these commands on Windows machine and not have to translate them then search for WSL (Windows Subsystem for Linux).
