...
def build_raw_image_start_cmd(args: argparse.Namespace, out_dir: Path) -> Optional[List[str]]:
    ...
    _append_arg(cmd, "--need_target_params", args.raw_image_need_target_params)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--raw_image_need_target_params", default="30M", help="Formulaic NEED size for optional raw-image pretraining.")
