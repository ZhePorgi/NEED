    ...
    with gr.Blocks(**blocks_kwargs) as demo:
        ...
        with gr.Tabs():
            with gr.Tab("Text"):
                ...
                with gr.Accordion("Preset profiles", open=True, elem_classes=["need-control-accordion"]):
                    preset = gr.Radio(["Balanced", "Fast CLI", "Deep aux_score", "Creative draft", "Raw diagnostics"], value="Balanced", label="Control preset")
